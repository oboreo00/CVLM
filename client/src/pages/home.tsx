  ...
  return (
    <>
      ...
      <div className="rag-root">
        ...
        <Dialog open={showReadmeModal} onOpenChange={setShowReadmeModal}>
          <DialogContent className="rag-readme-modal w-full max-w-2xl" onOpenAutoFocus={(e) => e.preventDefault()}>
            ...
            <div className="rag-readme-modal-content">
              <h2>What is CVLM?</h2>
              <p>
                CVLM is a sophisticated <strong>Retrieval-Augmented Generation (RAG)</strong> knowledge assistant designed to anchor your career history, skills, and personal data in verifiable ground truth.
              </p>
              ...
              <p>Delivers lightning-fast responses for repeated or similar queries.</p>
